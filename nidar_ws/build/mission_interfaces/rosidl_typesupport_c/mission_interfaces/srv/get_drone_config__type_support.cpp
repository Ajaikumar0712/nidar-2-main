...
static const _GetDroneConfig_Request_type_support_symbol_names_t _GetDroneConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mission_interfaces, srv, GetDroneConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mission_interfaces, srv, GetDroneConfig_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mission_interfaces, srv, GetDroneConfig_Request)() {
  return &::mission_interfaces::srv::rosidl_typesupport_c::GetDroneConfig_Request_message_type_support_handle;
}
...
static const _GetDroneConfig_Response_type_support_symbol_names_t _GetDroneConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mission_interfaces, srv, GetDroneConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mission_interfaces, srv, GetDroneConfig_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mission_interfaces, srv, GetDroneConfig_Response)() {
  return &::mission_interfaces::srv::rosidl_typesupport_c::GetDroneConfig_Response_message_type_support_handle;
}
...
static const _GetDroneConfig_type_support_symbol_names_t _GetDroneConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mission_interfaces, srv, GetDroneConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mission_interfaces, srv, GetDroneConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mission_interfaces, srv, GetDroneConfig)() {
  return &::mission_interfaces::srv::rosidl_typesupport_c::GetDroneConfig_service_type_support_handle;
}

...
class Metaclass_VictimDetection(type):
    """Metaclass of message 'VictimDetection'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_msgs.msg.VictimDetection')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__victim_detection
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__victim_detection
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__victim_detection
            cls._TYPE_SUPPORT = module.type_support_msg__msg__victim_detection
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__victim_detection
...
class VictimDetection(metaclass=Metaclass_VictimDetection):
    """Message class 'VictimDetection'."""
    ...
    _fields_and_field_types = {
        'cropped_image': 'sensor_msgs/Image',
        'latitude': 'double',
        'longitude': 'double',
        'confidence': 'float',
        'detection_id': 'string',
    ...
    def __init__(self, **kwargs):
        ...
        from sensor_msgs.msg import Image
        self.cropped_image = kwargs.get('cropped_image', Image())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.cropped_image != other.cropped_image:
            return False
    ...
    def cropped_image(self):
        """Message field 'cropped_image'."""
        return self._cropped_image

    @cropped_image.setter
    def cropped_image(self, value):
        if __debug__:
            from sensor_msgs.msg import Image
            assert \
                isinstance(value, Image), \
                "The 'cropped_image' field must be a sub message of type 'Image'"
        self._cropped_image = value

...
bool custom_msgs__msg__geotagged_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._geotagged_image.GeotaggedImage", full_classname_dest, 47) == 0);
  }
  custom_msgs__msg__GeotaggedImage * ros_message = _ros_message;
  {  // image
...
{
  /* NOTE(esteve): Call constructor of GeotaggedImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._geotagged_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeotaggedImage");
